...
FILE *fp = fopen(arquivo, "w");//Abre o arq. em modo escrita ("w")
if (fp == NULL) { // Testa se o arquivo abriu corretamente
...
FILE *fp = fopen(arquivo, "r"); //Abre o arq.em modo leitura ("r")
if (fp == NULL) {
